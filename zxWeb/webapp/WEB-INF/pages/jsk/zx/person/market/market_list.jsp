...
<html>
  ...
  <div class="container-fluid">
  	<form id="listForm" class="m20" action="${ctx}/secure/market/findPage" method="post">
    <table class="table-condensed">
      <tr>
        <td>商品名称：</td>
        <td><input name="title" id="title" class="form-control" value="${jskPersonMarket.title}" /></td>
        <td>
  ...
  <script type="text/javascript">
	$(function() {
		$("#btnAdd").click(function() {
			location.href = ctxjs + "/secure/market/create";
		});
	});
  </script>
  </body>

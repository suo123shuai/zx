...
public class WXPayController {
    ...
    public String wxpay(HttpServletRequest request, String orderId) {
        ...
        finalpackage.put("sign", map.get("sign"));
        //扩展字段
        finalpackage.put("packagea", "Sign=WXPay");
    ...
    public Map<String, String> weixinPrePay(String trade_no,BigDecimal totalAmount,  
        ...
        parameterMap.put("appid", "wx7b35475567490806");  //应用appid 
        parameterMap.put("mch_id", "1509705571");  //商户号

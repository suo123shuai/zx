...
public class UserServiceImpl extends BaseService implements IUserService {
	...
	@Override
	public int updCity(Integer pkId, String city) {
		JskSysUser user = new JskSysUser();
		user.setPkId(pkId);
		user.setCity(city);
		int i = jskSysUserMapper.updateByKey(user);
		return i;
	}

	@Override
	public JskSysUser findUser(Integer pkId) {
		JskSysUser user = jskSysUserMapper.findUserById(pkId);
		return user;
	}
}

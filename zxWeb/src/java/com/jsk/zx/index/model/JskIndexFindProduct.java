...
public class JskIndexFindProduct {
    ...
    private List<JskIndexStandard> JskIndexStandard;
	...
	public List<JskIndexStandard> getJskIndexStandard() {
		return JskIndexStandard;
	}

	public void setJskIndexStandard(List<JskIndexStandard> jskIndexStandard) {
		JskIndexStandard = jskIndexStandard;
	}
}
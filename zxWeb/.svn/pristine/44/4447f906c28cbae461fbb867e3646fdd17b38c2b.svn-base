...
public class JskSys1User {
    ...
    private List<JskSysAnnex> JskSysAnnex;
    ...
    public Float getAssureMoney() {
        return assureMoney;
    }

    public void setAssureMoney(Float assureMoney) {
	...
	public List<JskSysAnnex> getJskSysAnnex() {
		return JskSysAnnex;
	}

	public void setJskSysAnnex(List<JskSysAnnex> jskSysAnnex) {

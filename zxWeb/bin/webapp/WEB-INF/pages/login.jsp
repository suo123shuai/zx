...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/style/css/login/login.css"/>
...
$(function(){
  ...
  <body>
  	...
  	<form action="${ctx}/system/login" method="post" onsubmit="return checkForm();">
  	<DIV class="div_bottom">
		...
		<P style="padding: 30px 0px 10px; position: relative;">
			...
			<INPUT class="ipt" id="userName" name="userName" type="text" placeholder="请输入用户名" value="admin"/> 
    	</P>
